...
namespace AxeptiocookiesClasslib\Install;
...
use \Tab;
use \Tools;
use AxeptiocookiesClasslib\Db\ObjectModelExtension;
...
abstract class AbstractInstaller
{
    ...
    public function installAdminControllers()
    {
        ...
        foreach ($this->getAdminControllers() as $tabData) {
            ...
            if ($tabData['class_name'] == 'axeptiocookies' && version_compare(_PS_VERSION_, '1.7', '<')) {
