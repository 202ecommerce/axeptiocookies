...
class DbTableDefinitionRelation
{
    ...
    /**
     * @var axeptiocookiesObjectModelDefinition
     */
    protected $def;

    /**
     * Register axeptiocookiesObjectModelDefinition and the internal ID
     * @param axeptiocookiesObjectModelDefinition $def
     * @param string                $id
     */
    ...
    /**
     * Get key value from axeptiocookiesObjectModel::$definition['associations'][$this->id]
     * @param string $key
     * @return array|null
     */
