...
class ObjectModelDefinition
{
    ...
    /**
     * @var array of AxeptiocookiesClasslib\Db\DbTableDefinitionRelation
     */
    protected $relations;
    ...
    /**
     * @param string $id
     * @return AxeptiocookiesClasslib\Db\DbSchema
     */
    ...
    /**
     * @param string $id
     * @return AxeptiocookiesClasslib\Db\DbTableDefinitionRelation
     */
